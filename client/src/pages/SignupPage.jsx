    ...
    <div className="min-h-screen bg-[#f9f5f0] flex items-center justify-center px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Username */}
          <div>
            <label className="block text-sm font-medium mb-1 text-[#4b3f35]">
              Your Name
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-2.5 text-[#999] hover:text-[#555]"
              >
                {showPassword ? (
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-lg bg-[#f4a261] hover:bg-[#e76f51] text-white font-semibold transition"
          >
            Sign Up
          </button>
        </form>
        ...
        {/* Link to login */}
        <p className="text-center text-sm text-[#7a6e63]">
          <Link
            to="/login"
